...
All seven sessions are complete (Session 3 re-scoped to close at M14).
Every RxJS 7.8.2 root export is implemented and differentially certified;
the per-name evidence lives in `docs/CERTIFICATION-MATRIX.md` and the parity
